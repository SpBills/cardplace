                ...
                <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center">
                    <dt>
                      ...
                      <span className="mt-4 text-sm font-medium text-gray-900">International delivery</span>
                    </dt>
                  ...
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center">
                    <dt>
                      ...
                      <span className="mt-4 text-sm font-medium text-gray-900">Loyalty rewards</span>
                    </dt>
